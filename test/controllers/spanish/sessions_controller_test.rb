...
module SpanishRoutes
  class SessionsControllerTest < ActionDispatch::IntegrationTest
    ...
    def login(**params)
      post es_session_url, params: { email: @user.email, **params }
    end
    ...
    def new_es_session_url(**args)
      new_session_url :es, **args
    end

    def es_session_url(**args)
      session_url :es, **args
    end

    test "should get new" do
      get new_es_session_url
    ...
    test "should create session if given correct credentials" do
      ...
      assert_redirected_to home_root_url(:es)
    end
    ...
    test "should render new if given incorrect credentials" do
      ...
      assert_renders_new errors: "No se encontró la combinación de correo electrónico y contraseña"
    end
    ...
    test "should redirect to :after_login param when authenticated" do
      ...
      get new_es_session_url(after_login: "http://example.com/test-url")
